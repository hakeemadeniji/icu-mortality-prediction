...
- **[docs/VALIDATION_RESULTS.md](docs/VALIDATION_RESULTS.md)**: Discrimination/calibration report (AUROC per score); synthetic benchmark, regenerated by `backend/validate_scores.py`
- **[docs/MIMIC_VALIDATION.md](docs/MIMIC_VALIDATION.md)**: How to run the harness on a real MIMIC-IV cohort (access → SQL → CSV → report)
